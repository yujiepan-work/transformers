...
def main():
    ...
    if training_args.nncf_config is not None:
        ...
        # enable most simple and fast quantization calibration if quantization config exists
    ...
    if model_args.manual_load is not None:
        ...
        if model_args.manual_crop is True:
            ...
            model_label = "{}-{}".format(data_args.task_name, model.get_nncf_wrapped_model().__class__.__name__)
    ...
    # (input_ids, attention_mask, token_type_ids, ...)
        ...
        if nncf_config is not None:
            ...
            model_label = "{}-{}".format(data_args.task_name, model.__class__.__name__)
