...
def main():
    ...
    if training_args.do_eval:
        # ------------------------------------------------
        logger.info("*** Evaluate precrop model ***")
        precrop_metrics = trainer.evaluate()
        max_eval_samples = data_args.max_eval_samples if data_args.max_eval_samples is not None else len(eval_dataset)
        precrop_metrics["eval_samples"] = min(max_eval_samples, len(eval_dataset))
        ...
        cropped_metrics = trainer.evaluate()
        max_eval_samples = data_args.max_eval_samples if data_args.max_eval_samples is not None else len(eval_dataset)
        cropped_metrics["eval_samples"] = min(max_eval_samples, len(eval_dataset))

        trainer.log_metrics("eval_crop", cropped_metrics)
        trainer.save_metrics("eval_crop", cropped_metrics)
