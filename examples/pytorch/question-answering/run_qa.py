...
def main():
    ...
    if training_args.do_eval:
        ...
        if training_args.output_dir is not None:
            ...
            csvpath = os.path.join(training_args.output_dir, "{}linear_layer_sparsity_{:.0f}M_params_{:.2f}_sparsity.csv".format(
                                       prefix, linear_layer_total_params_in_mega,
            ...
            csvpath = os.path.join(training_args.output_dir, 
                                   "{}layer_wise_sparsity_global_rate_{:.2f}.csv".format(prefix, (1-df.nnz.sum()/df.nparam.sum())*100))
